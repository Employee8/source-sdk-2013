		...
		if (!g_fCombineQuestion)
		{
			...
			case 0: // check in
				if (m_Sentences.Speak("COMBINE_CHECK") >= 0)
				{
					if (m_bAllyCop)
					{
						m_Sentences.Speak("METROPOLICE_IDLE_CHECK_CR");
			...
			case 1: // question
				if (m_Sentences.Speak("COMBINE_QUEST") >= 0)
				{
					if (m_bAllyCop)
					{
						m_Sentences.Speak("METROPOLICE_IDLE_QUEST_CR");
		...
		else
		{
			...
			case 1: // check in
				if (m_Sentences.Speak("COMBINE_CLEAR") >= 0)
				{
					if (m_bAllyCop)
					{
						m_Sentences.Speak("METROPOLICE_IDLE_CLEAR_CR");
						g_fCombineQuestion = 0;
					}
					else
					{
			...
			case 2: // question 
				if (m_Sentences.Speak("COMBINE_ANSWER") >= 0)
				{
					if (m_bAllyCop)
					{
						m_Sentences.Speak("METROPOLICE_IDLE_ANSWER_CR");
						g_fCombineQuestion = 0;
					}
					else
					{
